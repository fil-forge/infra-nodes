# Piri's base config for the pilot-mad node.
#
...
# infra-central's `make fund-payer STAGE=staging`; this node never holds the money.
...
# Calibration testnet proxy contracts. Same addresses infra-central's staging
# stage runs against.
[pdp.contracts]
