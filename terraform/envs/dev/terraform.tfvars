...
# fil-forge/ucantool publishes no release binaries yet. Until it does, the node
# comes up without ucantool and keygen.sh refuses to run, naming this as the
# reason. Set both together — a version without a checksum installs an
# unverified binary that then generates the node's identity keys.
ucantool_version = ""
ucantool_sha256  = ""
